export const NFT_CLAIM_ABI = [
	...
	},
	{
		inputs: [
			{ internalType: "uint16", name: "chainId", type: "uint16" },
			{ internalType: "address", name: "blockUpdater", type: "address" },
		],
	...
	},
	{
		inputs: [
			{ internalType: "uint16", name: "chainId", type: "uint16" },
			{ internalType: "address", name: "mptVerifier", type: "address" },
		],
		name: "setMptVerifier",
		outputs: [],
		stateMutability: "nonpayable",
	...
	},
	{
		inputs: [
			...
			{ internalType: "bytes32", name: "srcBlockHash", type: "bytes32" },
			{ internalType: "uint256", name: "logIndex", type: "uint256" },
			{ internalType: "bytes", name: "mptProof", type: "bytes" },
		],
